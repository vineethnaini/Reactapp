...
function deleteUser(id) {
    return axios.delete('http://localhost:8000/users/'+id,{
      withCredentials: true
    }
  )
  .then((response) =>{
...
function roleChange(id,role) {
    return axios.get('http://localhost:8000/users/'+id+'/role_change/',{
      params: {
        roles : role
      }
    },{
...
function getPie(){
  return axios.get('http://localhost:8000/tasks/dashboard/pie',{
    withCredentials: true
  }
)
.then((response) =>{
...
function getListTasks(title,assignee_id,assigner_id,start_time,end_time,currentPage){
  return axios.get('http://localhost:8000/tasks/filter',{
    params: {
      search: title,
...
function taskStatus(id,status) {
  return axios.get('http://localhost:8000/tasks/'+id+'/status_update/',{
    params: {
      status: status
    }
  },{
...
function taskEditing(id,title,description,duetime) {
  return axios.get('http://localhost:8000/tasks/'+id+'/edit/',{
    params: {
      title: title,
