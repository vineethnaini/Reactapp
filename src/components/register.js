...
import { userActions } from '../actions/user.actions';import Col from 'react-bootstrap/Col'
...
class Register extends React.Component{
    ...
    handleSubmit(event) {
      alert('Registration details' +this.state.name + this.state.email + this.state.password );
