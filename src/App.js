...
class App extends React.Component {
    ...
    return (
      ...
      <Router>
        ...
        <Navbar className = "topnav" expand="lg">
          <Navbar.Brand className = "active" href="/">Home</Navbar.Brand>
            <Navbar.Toggle aria-controls="basic-navbar-nav" />
            <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto" variant = "pills">
            <Link to ="/login" className = "glyphicon glyphicon-user mx-1">Login</Link>
  ...
  return (
    ...
    <Router>
      <div>
      <Navbar className = "topnav" expand="lg">
          <Navbar.Brand className = "active" href="/">Task Management</Navbar.Brand>
          <Nav className="mr-auto" variant = "pills">
            <Link to ="/users/" className = "mx-1">Services</Link>
          </Nav>
